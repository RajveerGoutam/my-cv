            ...
            <ul className="contacts-list">
              <li className="contact-item">
                ...
                <div className="contact-info">
                  ...
                  <a href="mailto:gkr7595296@gmail.com" className="contact-link">
                    gkr7595296@gmail.com
                  </a>
                </div>
              </li>
              ...
              {/* <li className="contact-item">
                ...
                <div className="contact-info">
                  ...
                  <a href="tel:+91 7061463610" className="contact-link">
                    +91 7061463610
                  </a>
                </div>
              </li> */}
              ...
              <li className="contact-item">
                ...
                <div className="contact-info">
                  ...
                  <time dateTime="2001-05-27">Dec 17, 2001</time>
                </div>
              </li>
              ...
              <li className="contact-item">
                ...
                <div className="contact-info">
                  ...
                  <address>Jamshedpur, Jharkhand, India</address>
                </div>
              </li>
            </ul>

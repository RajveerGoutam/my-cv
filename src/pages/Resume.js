...
{/* 
            ...
            <section className="timeline">
              ...
              <ol className="timeline-list">
                <li className="timeline-item">
                  <h4 className="h4 timeline-item-title"> Bachelor Of Technology  </h4>

                  <span>IIIT Bhubaneswar, Odisha ( 2021 — 2025 )</span>

                  <p className="timeline-text">CGPA - 8.67%</p>
                </li>

                <li className="timeline-item">
                  <h4 className="h4 timeline-item-title">Intermediate ( Physics , Chemistry, Maths )</h4>

                  <span>Nezamia Public School, Patna, Bihar ( 2019 )</span>

                  <p className="timeline-text">Percentage - 84.2%</p>
                </li>

                <li className="timeline-item">
                  <h4 className="h4 timeline-item-title">Matriculation</h4>

                  <span> Jusco School South Park, Jamshedpur, Jharkhand ( 2017 )</span>

                  <p className="timeline-text">CGPA - 9.2</p>
                </li>
              </ol>
            </section>
